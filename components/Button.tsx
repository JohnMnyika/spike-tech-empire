...
const buttonVariants = {
  ...
  secondary:
    "bg-navy-800 text-white hover:bg-navy-900 active:scale-95",
  outline:
    "border-2 border-cyan-500 text-cyan-500 hover:bg-cyan-50 dark:hover:bg-navy-900",
  ghost:
    "text-navy-900 dark:text-white hover:bg-navy-100 dark:hover:bg-navy-800",
};
